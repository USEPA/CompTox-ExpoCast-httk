...
#' \item{Fds}{Fraction of dead space in lungs.} \item{Vdot}{Respiratory minute
#' volume, ml/s.}
#' 
...
#' @keywords Parameter
#' @export parameterize_aerosol_pbtk



parameterize_aerosol_pbtk <- function(chem.cas=NULL,
                              chem.name=NULL,
                              species="Human",
                              default.to.human=F,
...
# 9 filters plus inhalability
	...
	#henry's law in atm * m^3 / mol, converted atm to Pa
   	#human body temperature of 310 Kelvin
        ...
        outlist <- c(outlist,Fdeposited=Fdeposited,DEalv=dea,Fds=Fds,Vdot=Vdot,Kblood2air=Kblood2air)
