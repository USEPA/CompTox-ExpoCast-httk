#Series of analogous convenience Boolean (yes/no) functions with similar,
#largely redundant roxygen documentation blocks to be exported to the user
#for help in identifying chemical membership in several key lists.
...
#' is.nhanes.urine.analyte is.tox21 is.toxcast is.expocast is.httk is.pharma
                    ...
                    which.list="ToxCast")
{
  ...
  if (!suppressWarnings(CAS.checksum(chem.cas))) stop (paste("Chemical CAS",chem.cas,"fails checksum."))
