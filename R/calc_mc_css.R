...
#' \code{\link{invitro_mc}}, including adjusted.Funbound.plasma, which uses
#' adjusted Funbound.plasma when TRUE along with partition coefficients
#' calculated with this value; poormetab, a logical to include (TRUE) or
#' exclude (FALSE) poor metabolizers; fup.censored.dist, a logical
#' indicating Whether to draw \code{Funbound.plasma} from a censored 
#' distribution or not; fup.lod, the average limit of detection for 
#' Funbound.plasma (if \code{fup.censor == TRUE}, the \code{Funbound.plasma}
#' distribution will be censored below \code{lod/2}. Default value is 0.01.); 
#' fup.meas.cv, coefficient of variation of distribution of measured 
#' \code{Clint} values; clint.meas.cv, coefficient of variation of distribution
#' of measured \code{Clint} values; fup.pop.cv, coefficient of variation of
#' distribution of population \code{Funbound.plasma} values; and clint.pop.cv, 
#' coefficient of variation of distribution of population \code{Clint} values.
...
calc_mc_css <- function(chem.cas=NULL,
                        ...
                        parameterize.arg.list=list(
                          ...
                          regression=T),
                        calc.analytic.css.arg.list=list( #basketball
