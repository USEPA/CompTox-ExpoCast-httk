...
#' 
#' A data.table where each row represents an individual, and each column
...
#' Environment International 106 (2017): 105-118 Generate a virtual population
#' by the virtual individuals method.
#' 
#' Generate a virtual population by the virtual individuals method.
#' 
