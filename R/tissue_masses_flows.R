...
#' 
#' 
#' @param tmf_dt A data.table generated by \code{gen_age_height_weight()},
#' containing variables \code{gender}, \code{reth}, \code{age_months},
#' \code{age_years}, \code{weight}, and \code{height}.
#' @return The same data.table, with aditional variables describing tissue
#' masses and flows.
#' @author Caroline Ring
#' @references Ring, Caroline L., et al. "Identifying populations sensitive to
