...
Fig1b <- ggplot(Fig1.table)+
   ...
   xlab(expression(paste("Measured ",Cl[int]," (ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂµL/min/",10^6," hepatocytes)"))) +
  ylab("Number of chemicals")+
...
#Figure 4:
Comparison of Bayesian Clint and Uncertainty Estimations to Experimental Point Estimates. Clint estimate for 1 ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂµM chemical concentration displayed, though 1 and 10 ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂµM were fit jointly. The size of the credible interval varies significantly from chemical to chemical, especially for the lower clearance rates. Plots of individual fits are provided as supplemental material 
...
Fig5b <- ggplot(data=ceetox,aes(x=cssmed,y=cssmed_u)) +
  ...
  xlab(expression(paste(C[ss]," Point Estimate (ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂµM)")))+
  ylab(expression(paste("Bayesian ",C[ss]," (ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂµM)")))+
