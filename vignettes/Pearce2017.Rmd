...
knitr::opts_chunk$set(collapse = TRUE, comment = '#>', fig.width=6, fig.height=5)library(httk)
library(gdata)
library(ggplot2)
library(viridis)
library(CensRegMod)
...
for(this.cas in obach[,'CAS']){
  ...
  vdist <- calc_vdist(parameters=c(pcs,Funbound.plasma=parameters$Funbound.plasma),suppress.messages = TRUE)
