...
extern void getParmsfetalpbtk(double *, double *, void *);
extern void initmodpbtk(void *);
extern void initmodfetalpbtk(void *);
extern void initmod1comp(void *);
extern void initmod3comp(void *);
extern void derivspbtk(int *, double *, double *, double *, double *, int *);
extern void derivsfetalpbtk(int *, double *, double *, double *, double *, int *);
...
extern void jacfetalpbtk(int *, double *, double *, int *, int *, double *, int *, double *, int *);
...
extern void eventfetalpbtk(int *, double *, double *);
...
extern void rootfetalpbtk (int *, double *, double *, int *, double *, double *, int *);
