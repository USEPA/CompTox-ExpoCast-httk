/* aerosol.c for R deSolve package
...
void initforc_aerosol (void (* odeforcs)(int *, double *))
{
  int N=1;
  odeforcs(&N, forc);
}
...
void getParms_aerosol (double *inParms, double *out, int *nout) {
/*----- Model scaling */
...
void derivs_aerosol (int *neq, double *pdTime, double *y, double *ydot, double *yout, int *ip)
{
...
void jac_aerosol (int *neq, double *t, double *y, int *ml, int *mu, double *pd, int *nrowpd, double *yout, int *ip)
{
...
/*----- Events calculations: */
void event_aerosol (int *n, double *t, double *y)
{

} /* event */

/*----- Roots calculations: */
void root_aerosol (int *neq, double *t, double *y, int *ng, double *gout, double *out, int *ip)
{
