...
Until we have a production version of a database, we rely on a script to compile HTTK data (including in vitro measurements, in vivo measurements, and physico-chemical properties) from an ever-growing list of various papers. The script and supporting data are stored here.
