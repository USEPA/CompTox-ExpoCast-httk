...
```{r}
out_path <- "C:/Users/cring/OneDrive - Environmental Protection Agency (EPA)/httk/gfr_changes_output/HTTK108_test/"
```
...
#recalculate GFR for the same population for each set of conditions -- this controls for random variation in other things (such as age, sex, etc.)
DT <- par[,
          .(gfr_est={
