...
author: "Dustin F. Kapraun, Mark Sfeir, Robert Pearce, Sarah Davidson, Annie Lumen, André Dallmann, Richard Judson, and John F. Wambaugh"
date: "`r Sys.Date()`"
...
```{r Rfetmat_uncertainty, eval = TRUE}
...
```{r Rfetbrain_uncertainty, eval = TRUE}
...
```{r Wang_Uncertainty_Propagation, eval = TRUE}
