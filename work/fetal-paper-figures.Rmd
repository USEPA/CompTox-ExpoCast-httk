...
cat(paste(
  ...
  subset(Curley.pcs,Compound=="Bisphenol A" & Tissue=="Placenta")[,"PC"],
  "for Bisphenol A and ",
  subset(Curley.pcs,Compound=="Daidzein" & Tissue=="Placenta")[,"PC"],
  "for Diadzen) the predictions were ",
  subset(Curley.pcs,Compound=="Bisphenol A" & Tissue=="Placenta")[,"HTTK.pred"],
  " and ",
  subset(Curley.pcs,Compound=="Daidzein" & Tissue=="Placenta")[,"HTTK.pred"],
  ", respectively.\n",sep=""))


```
```{r weijs2013_loadPCs, eval = TRUE}
