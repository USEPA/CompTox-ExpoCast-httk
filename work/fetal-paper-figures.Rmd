...
TKstats <- read.xls("MaternalFetalAUCData.xlsx",stringsAsFactors=FALSE)
...
# AFE:
mean(TKstats$Predicted.Pregnant.httk/TKstats$Observed.Pregnant5)
# RMSLE
(mean((log10(TKstats$Predicted.Pregnant.httk)-log10(TKstats$Observed.Pregnant5))^2))^(1/2)
