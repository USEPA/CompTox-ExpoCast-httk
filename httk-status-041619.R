...
all.chems <- sort(unique(c(Cyprotex.forgot, Cyprotex.Caco2,Health.Canada,JRC,unilever, invivo,Cyprotex.attempted,httk110.human,httk110.rat,shark1,shark2,shark3,sharkbackfill,TSCA.430,TSCA.poc)))
...
for (this.id in all.chems)
{
      ...
      colnames(this.row) <- c("DTXSID","TSCA","TSCA.PoC","TSCA.430","Tox21","ToxCast","Unilever","Health.Canada","JRC","HTTK.1.10.Human","HTTK.1.10.Rat","HTTK.Cyprotex.Clint","HTTK.Cyprotex.Fup","HTTK.Cyprotex.Caco2","HTTK.Cyprotex.Failed","HTTK.Cyprotex.Forgot","Sharktank.1","Sharktank.2","Sharktank.3","Sharktank.Backfill")
