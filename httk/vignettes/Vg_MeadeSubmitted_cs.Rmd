...
vignette: >
 %\VignetteIndexEntry{g) Meade (Submitted): High Throughput Dermal Exposure Model}
 %\VignetteEngine{knitr::rmarkdown}
 %\VignetteEncoding{UTF-8}
---
*Please send questions to wambaugh.research@gmail.com or aemeade7@gmail.com*
...
run.simulations <- TRUE # Change FALSE to TRUE here to make the vignette work
make.plots <- TRUE # change to TRUE to make the plots
run.simulations.2 <- TRUE #for second part of vignette
make.plots.2 <- TRUE # change to TRUE to make the plots
```
...
```{r setup, eval = TRUE, eval = run.simulations}
...
loc.wd = "C:/Users/cschacht/OneDrive - Environmental Protection Agency (EPA)/Profile/Documents/CCTE_2023_2024/dermal/Random_files_tokeep/Vignette"
...
#loc.httk="C:/Users/cschacht/OneDrive - Environmental Protection Agency #(EPA)/Profile/Documents/CCTE_2023_2024/dermal/httk-dev-feature-dermal2@41bec5ca743"
...
plot
ggsave(paste(getwd(), "/Figures_August2025/BPvsRMSLE_suppl.png",sep=""),
...
ggsave(paste(getwd(), "/Figures_August2025/BPvsRMSLE_cmax_suppl.png",sep=""),
       width = 20, height = 10, units = "in")
...
ggsave(paste(getwd(), "/Figures_August2025/BP_RMSLE_Exhalation_main.png",sep=""),
       width = 20, height = 10, units = "in")
...
for(chx in 1:length(chem)){
 ...
 ggplot(each.chem)+
  ...
  ggsave(paste(getwd(), "/Figures_August2025/cvt_eachchem_by_exhalation_suppl", unique(each.chem$test_substance_dtxsid),".png",sep=""),
...
for(chx in 1:length(chem)){
  ...
  ggsave(paste(getwd(), "/Figures_August2025/pvo_bydose_suppl", unique(each.chem$test_substance_dtxsid),".png",sep=""),
...
ggsave(paste(getwd(), "/Figures_Sep2025/PvO_main.png",sep=""),
...
auc.pvo=ggplot(auc.df, aes(x=auc_observed, y=auc_pred))+
  ...
  theme(plot.title=element_text(hjust=0.5),
        text=element_text(size=30))
ggsave(paste(getwd(), "/Figures_Sep2025/PvO_AUC.png",sep=""),
...
ggsave(paste(getwd(),"/Figures_August2025/RMSLE_compare_main_september.png",sep=""),width=11,height=8,units="in")
...
plot <- ggplot(data,aes(x=`Equivalent Dose`)) +
  ...
  theme(plot.title=element_text(hjust=0.5))
plot  
ggsave(paste(getwd(), "/Figures_August2025/histogram2.png",sep=""),
...
#                  hjust = "right",nudge_x=-1,nudge_y=0.2)+
  ...
  theme(plot.title=element_text(hjust=0.5),
        text=element_text(size=20))
plot  
ggsave(paste(getwd(), "/Figures_August2025/histogram_all_main.png",sep=""),
...
ggsave(paste(getwd(), "/Figures_August2025/MWvPerm.png",sep=""),
...
ggsave(paste(getwd(), "/Figures_August2025/logKowvPerm.png",sep=""),
       width = 4, height = 3.5, units = "in")


```

```{r save_workspace, eval=make.plots.2}
...
print(pca.fig)
ggsave(paste(getwd(), "/Figures_August2025/pca.png",sep=""),
       width = 4, height = 3.5, units = "in")
```