...
R package "httk" provides pre-made, chemical independent ("generic") models and chemical-specific data 
...
Searchable Toxicity (DSSTox) database [138]). Available chemical-
