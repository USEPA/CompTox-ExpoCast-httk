---
title: "Linakis et al. (2020): High Throughput Inhalation Model (updated)"
author: "Matt Linakis"
date: "January 30, 2020"
output: rmarkdown::html_vignette
vignette: >
 %\VignetteIndexEntry{g) Linakis (2020): High Throughput Inhalation Model (updated)}
...
# Error in CvT (identified by Xiaoqing Chang)?
```{r baddata, eval=execute.vignette}
conc_data <- subset(conc_data, SOURCE_CVT != "6845373")
```

# paper gives different doses
```{r correct_doses, eval=execute.vignette}
