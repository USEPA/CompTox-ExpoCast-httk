...
#for saving outputs
data.date <- "10JUN2025"
path_out <- "C:/Users/mscherer/OneDrive - Environmental Protection Agency (EPA)/Profile/Desktop/ManuscriptDataJourney/"
...
names(armitageOutput_curated.data.dt)
armitageOutput_curated.data.dt %>% select(Name, Arnot_pka, Arnot_pkb, log.KOW.N, log.KAW.N)
```
...
#9 citations did not measure experimental dose at all
#132 observations
...
exp_nom.dt<-copy(IVD_Manuscript_data[!(is.na(ExperimentalDose_uM)),]) #25 entries
