...
setwd("C:/Users/mscherer/httk-dev") # to load httk
devtools::load_all("httk") # for unit conversions
...
cycA.dt<-copy(IVD_Manuscript_data %>% 
...
#pull cyc a values from input data
cycA.dt<-copy(IVD_Manuscript_data %>% dplyr::filter(ChemicalName == "Cyclosporin A"))
...
```{r cell_type_tableS11}

#copy for editing
celltype_rmsle<-copy(stacked.data)
...
#calculate RMSLSE and r^2 for each model and ionization type
celltype_rmsle_output<- copy(celltype_rmsle[label=="Armitage", 
