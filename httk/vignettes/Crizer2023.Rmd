...
httk.chem.list <- get_cheminfo(model="3compartmentss2", info="DTXSID")
...
cl.table$Class <- "PFAS"
cl.table[!(cl.table$DTXSID %in% new.pfas), "Class"] <- "Other"
cl.table$Class <- factor(cl.table$Class, levels=c("PFAS","Other"))
```
