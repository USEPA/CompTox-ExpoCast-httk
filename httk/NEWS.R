...
Changes in version 2.0.5 (Summer, 2021)
  ...
  Added function calc_halflife (thank you Imran Shah for idea)
  Internal reusable function convert_units() added to ensure consistency in unit conversions acrpss functions
  Units corrected for gas_pbtk model to more antuarlly handle ppmv (parts per million by volume) and uM
  ...
  Expanded documentation for function get_cheminfo and table chem.phys_and_invitro.data (thank you Lynne Lynne Haber and Mark Bradley)
