...
model.list[[THIS.MODEL]]$parameterize.func <- "parameterize_pfas1comp"

# Function called for running the model:
model.list[[THIS.MODEL]]$solve.func <- "solve_1comp"
...
# parameters:
model.list[[THIS.MODEL]]$compiled.parameters.init <- "getParms1comp"
...
model.list[[THIS.MODEL]]$compiled.init.func <- "initmod1comp"

# This is the function that calculates the derviative of the model as a function
# of time, state, and parameters:
model.list[[THIS.MODEL]]$derivative.func <- "derivs1comp"
...
model.list[[THIS.MODEL]]$log.henry.threshold <- NULL

# Filter out compounds belonging to select chemical classes
model.list[[THIS.MODEL]]$chem.class.filt <- NULL
