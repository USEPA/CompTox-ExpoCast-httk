...
armitage_eval <- function(chem.cas=NULL,
                          ...
                          this.pseudooct = 0.005, # storage lipid content of cells
                          this.memblip = 0.025, # membrane lipid content of cells
                          this.nlom = 0.1, # structural protein content of cells
