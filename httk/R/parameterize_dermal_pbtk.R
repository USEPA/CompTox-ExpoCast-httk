...
#' @param skin.pH pH of dermis/skin, used in calculating P and Kskin2media.
...
#' vehicle) carrying the chemical to water. Default is NULL, which assumes the media is water.
