...
model.list[["skin_2subcomp"]]$parameterize.func <- "parameterize_skin_2subcomp" 
...
model.list[["skin_2subcomp"]]$Rtosolvermap <- list(
  ...
  Qcardiacc = "Qcardiacc",
  Qgfrc = "Qcardiacc",
  Qcomposite_dermalc = "Qcomposite_dermalc",
  Qgutc = "Qgutc",
  Qkidneyc = "Qkidneyc",
  Qliverc = "Qliverc",
  Vartc = "Vartc",
...
# parameters:
model.list[["skin_2subcomp"]]$compiled.parameters.init <- "getParms_skin_2subcomp"
...
model.list[["skin_2subcomp"]]$compiled.param.names <- c(
  skin_depth,
  Fskin_depth_sc,
  Fskin_depth_cd,
  Pmedia2sc,
...
model.list[["skin_2subcomp"]]$compartment.units <- c(
  "Cgut"="uM",
  "Cliver"="uM",
  "Cven"="uM",
  "Clung"="uM",
...
model.list[["skin_2subcomp"]]$routes <- c("oral","iv","dermal")
...
model.list[["skin_2subcomp"]]$state.vars <- c(
  "Agutlumen",
  "Agut",
  "Aliver",
  "Aven",
