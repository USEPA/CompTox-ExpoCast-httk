...
#' @param times Optional time sequence for specified number of output times (in days) to be returned by function.
#' Model is solved explicitly at time sequence specified and dosing sequence begins at the first time provided.
