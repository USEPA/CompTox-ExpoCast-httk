#' Calculate Monte Carlo Gas Equivalent Dose
#' 
#' This functions converts a chemical plasma concetration to an gas equivalent
...
#' 
#' Tissue concentrations are calculated for the gas pbtk model with inhalation
#' dosing.  
#' 
...
#' 
#' \dontrun{
#' calc_mc_gas_equiv(0.1,chem.cas="129-00-0",which.quantile=c(0.05,0.5,0.95),
#'                    samples=100,tissue='brain')
#' }
#' 
#' @export calc_mc_gas_equiv
calc_mc_gas_equiv <- function(conc,
                               chem.name=NULL,
                               chem.cas=NULL,
                               dtxsid=NULL,
                               which.quantile=0.95,
