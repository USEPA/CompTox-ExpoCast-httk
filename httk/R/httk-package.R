...
#' @seealso
#' \href{httpss://www.epa.gov/chemical-research/computational-toxicology-communities-practice-high-throughput-toxicokinetic-httk-r}{PowerPoint
#' Presentation: High-Throughput Toxicokinetics (HTTK) R package}
#' 
#' \href{httpss://doi.org/10.18637/jss.v079.i04}{Pearce et al. (2017): httk: R
#' Package for High-Throughput Toxicokinetics}
#' 
#' \href{httpss://doi.org/10.1093/toxsci/kfv171}{Wetmore et al. (2015):
