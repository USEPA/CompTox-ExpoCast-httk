#' Converts the HTTK-Pop population data table to a table of the model parameters
#' needed by HTTK
#' 
#' This is the core function for httk-pop human physiological variability
#' simulation as described by Ring et al. (2017) 
