...
void derivs3comp (int *neq, double *pdTime, double *y, double *ydot, double *yout, int *ip)
{
  ...
  ydot[ID_Aportven] = kgutabs * y[ID_Aintestine] + Qgut * y[ID_Csyscomp] * Ratioblood2plasma / Fraction_unbound_plasma / Krest2plasma - Qgut * y[ID_Cportven] ;

  ydot[ID_Aliver] = Qgut * y[ID_Cportven] + Qliver * y[ID_Csyscomp] * Ratioblood2plasma / Fraction_unbound_plasma / Krest2plasma - ( Qliver + Qgut ) * y[ID_Cliver] * Ratioblood2plasma / Fraction_unbound_plasma / Kliver2plasma - CLmetabolism / Kliver2plasma * y[ID_Cliver] ;

  ydot[ID_Asyscomp] = ( Qgut + Qliver ) * y[ID_Cliver] * Ratioblood2plasma / Fraction_unbound_plasma / Kliver2plasma - ( Qgut + Qliver ) * y[ID_Csyscomp] * Ratioblood2plasma / Fraction_unbound_plasma / Krest2plasma - Qgfr / Krest2plasma * y[ID_Csyscomp] ;

  ydot[ID_Ametabolized] = CLmetabolism / Kliver2plasma * y[ID_Cliver] ;

  ydot[ID_Atubules] = Qgfr / Krest2plasma * y[ID_Csyscomp] ;
