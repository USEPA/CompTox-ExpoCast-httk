...
extern void getParms_skin_2subcomp(double *, double *, int *);
...
extern void initmod_skin_2subcomp(void *);
...
extern void derivs_skin_2subcomp(int *, double *, double *, double *, double *, int *);
...
extern void jac_skin_2subcomp(int *, double *, double *, int *, int *, double *, int *, double *, int *);
...
extern void event_skin_2subcomp(int *, double *, double *);
...
extern void root_skin_2subcomp (int *, double *, double *, int *, double *, double *, int *);
...
static const R_CMethodDef CEntries[] = {
    ...
    {"getParms_skin_2subcomp", (DL_FUNC) &getParms_skin_2subcomp, 3},
//    {"getParms", (DL_FUNC) &getParms, 4},
    ...
    {"initmod_skin_2subcomp", (DL_FUNC) &initmod_skin_2subcomp, 1},
    ...
    {"derivs_skin_2subcomp", (DL_FUNC) &derivs_skin_2subcomp, 6},
    ...
    {"jac_skin_2subcomp", (DL_FUNC) &jac_skin_2subcomp, 9},
    ...
    {"event_skin_2subcomp", (DL_FUNC) &event_skin_2subcomp, 3},
    ...
    {"root_skin_2subcomp", (DL_FUNC) &root_skin_2subcomp, 7},
    {NULL, NULL, 0}
};
