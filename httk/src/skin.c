/* skin.c for R deSolve package
   ___________________________________________________

   Model File:  skin.model
...
#define Qskin parms[20]
#define Qskinexposed parms[21]
...
#define Vskin parms[33]
#define Vskinexposed parms[34]
...
/*----- Initializers */
void initmod_skin (void (* odeparms)(int *, double *))
{
  int N=51;
  odeparms(&N, parms);
}

void initforc_skin (void (* odeforcs)(int *, double *))
{
  int N=2;
  odeforcs(&N, forc);
}
...
void getParms_skin (double *inParms, double *out, int *nout) {
/*----- Model scaling */
...
void derivs_skin (int *neq, double *pdTime, double *y, double *ydot, double *yout, int *ip)
{
  /* local */ double Vmedia;
...
void jac_skin (int *neq, double *t, double *y, int *ml, int *mu, double *pd, int *nrowpd, double *yout, int *ip)
{
...
/*----- Events calculations: */
void event_skin (int *n, double *t, double *y)
{

} /* event */

/*----- Roots calculations: */
void root_skin (int *neq, double *t, double *y, int *ng, double *gout, double *out, int *ip)
{
