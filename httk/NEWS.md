...
* Added cutoff of logKow/logDow no greater than 6 for 'calc_fup_correction' and 'calc_hep_fu' based on the idea that they are not long enough to reach concentration ratios greater than 1,000,000 to 1
