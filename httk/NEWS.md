...
* Revised ionization code in 'armitage_eval' -- air:water partitioning now only for neutral compound(thank you Jon Arnot), pka_donor and pka_accept values now correctly used (thank you Meredith Scherer)
